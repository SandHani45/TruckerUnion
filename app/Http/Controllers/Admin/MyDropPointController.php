...
Use Alert;
class MyDropPointController extends Controller
{
    ...
    {
        $drop_poins = DropPoint::where('admin_id', 1)->get();
        return view('admin.pages.mydroppoint.my-drop-point', compact('drop_poins'));
    }

    public function create()
    {
      return view('admin.pages.add_drop_point');
    } 
    ...
    {   
        ...
        if ($drop_point) {
           ...
           return redirect(route('my-drop-points.index'));
        }
    }
    ...
    {   
        ...
        return view('admin.pages.mydroppoint.edit-my-drop-point', compact('drop_point','timings'));
    }

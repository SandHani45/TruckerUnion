...
class GroupController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.pages.groups.group',compact('groups'));
    }
  
    public function create()
    {
         
        return view('admin.pages.groups.add_group');
    }
    ...
    public function show($id)
    {
        $userDatas = DB::table('group_members')
            ...
            ->get(['group_members.id',
                    ...
                    'users.phone_number']);
        return view('admin.pages.groups.group-members', compact('userDatas'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.pages.groups.edit_group', compact('groups'));
    }

  ...
  <section id="drop" class=""> 
    <div class="container">
      <div class="row pd-top-15">
        <div class="col-sm-12 mt-0">
          ...
          <h4 class="text-capitalize" ><b> {{-- {{ Auth::user()->name }} --}} </b>My Drop off points</h4>
    ...
    <div class="row">
            ...
            @foreach($drop_poins as $drop_point)
              <tr >
                <td class="media" style="width: 75%">
                  <img class="locator" src="{{URL::asset('img/locator.svg')}}" alt=""> 
                  <a class="drop" href="{{ route('my-drop-points.edit', $drop_point->id)}}">{{ $drop_point->name }} ,{{ $drop_point->address }}    </a>
                </td>
                <td style="width: 25%"><a  class="red-icon" href="" onclick="
                    ...
                    <form id="delete-form-{{$drop_point->id}}" action="{{ route('my-drop-points.destroy', $drop_point->id) }}" style="display: none;" method="post">
                      @csrf
                      {{method_field('DELETE')}}
                    </form>
                </td>
       ...
       <div class="col-md-2 search-set">
         <div class="add-drop">  
            <a href="{{ route('my-drop-points.create')}}" class="pd-drop">

    ...
    <div class="container">
      <div class="row pd-top-15">
        <div class="col-sm-12 mt-0">
          ...
          <h4 class="text-capitalize" ><b> {{-- {{ Auth::user()->name }} --}} </b>All Drop off points</h4>
            ...
            @foreach($drop_poins as $drop_point)
              <tr >
                <td class="media" style="width: 75%">
                  ...
                  <a class="drop" href="{{ route('all-drop-points.edit', $drop_point->id)}}">{{ $drop_point->name }} ,{{ $drop_point->address }}    </a>
                </td>
